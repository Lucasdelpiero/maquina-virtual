...
typedef void (_Operacion0)(Vmx _);
typedef void (_Operacion1)(Vmx _, int, int);
typedef void (_Operacion2)(Vmx _, int, int, int, int);
...
void MUL(Vmx _vmx , int tipoA ,int datoA , int tipoB , int datoB) {
int32_t valorA = get_valor(vmx, tipoA, datoA);
int32_t valorB = get_valor(vmx, tipoB, datoB);
int32_t Resultado = valorA _ valorB;
int carry = ((uint64_t)(uint32_t)valorA _ (uint32_t)valorB) > Maximo;
int desbordamiento = ((int64_t)valorA _ valorB > Maximo || (int64_t)valorA \* valorB < Minimo);
ActualizarCC(vmx , Resultado , carry , desbordamiento);
Guardar_Resultado(vmx , tipoA , datoA , Resultado);
}
...
void SHL(Vmx _vmx , int tipoA ,int datoA , int tipoB , int datoB) {
int32_t valorA = get_valor(vmx, tipoA, datoA);
int32_t valorB = get_valor(vmx, tipoB, datoB);
int32_t Resultado ;
int32_t carry = 0;
int desbordamiento = ((int64_t)valorA _ ((int64_t)1 << valorB) > Maximo || (int64_t)valorA \* ((int64_t)1 << valorB) < Minimo);
int i = 0;
